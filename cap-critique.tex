...
\subsection{The problem with liveness}\label{sec:liveness}
...
In section~\ref{sec:alternatives} we explore an alternative formulation of the trade-off between
consistency and availability, focussing on \emph{latency}.
